...
```bash
sudo dpkg -i ../gtk3sermo_1.1.0-1_amd64.deb
# ou avec gestion automatique des dépendances manquantes :
sudo apt-get install -f ../gtk3sermo_1.1.0-1_amd64.deb
```
...
Dockerfile fait `COPY gtk3sermo/gtk3sermo_1.1.0 .`. Lancer la commande depuis
`gtk3sermo_1.1.0/` échoue.
