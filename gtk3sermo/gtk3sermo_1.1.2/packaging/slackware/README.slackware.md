...
# Résultat
ls /tmp/gtk3sermo-1.1.2-x86_64-1_sermo.tgz
```

## Installation

```bash
sudo installpkg /tmp/gtk3sermo-1.1.2-x86_64-1_sermo.tgz
# ou
sudo upgradepkg --install-new /tmp/gtk3sermo-1.1.2-x86_64-1_sermo.tgz
```
