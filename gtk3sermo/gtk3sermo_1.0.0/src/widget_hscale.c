...
gchar *widget_hscale_envvar_construct(GtkWidget *widget)
{
	...
	switch (digits) {
		case 0:
			g_snprintf(value, sizeof(value), "%.0f", val);
			break;
		case 1:
			g_snprintf(value, sizeof(value), "%.1f", val);
			break;
		case 2:
			g_snprintf(value, sizeof(value), "%.2f", val);
			break;
		case 3:
			g_snprintf(value, sizeof(value), "%.3f", val);
			break;
		case 4:
			g_snprintf(value, sizeof(value), "%.4f", val);
			break;
		case 5:
			g_snprintf(value, sizeof(value), "%.5f", val);
			break;
		case 6:
			g_snprintf(value, sizeof(value), "%.6f", val);
			break;
		case 7:
			g_snprintf(value, sizeof(value), "%.7f", val);
			break;
		case 8:
			g_snprintf(value, sizeof(value), "%.8f", val);
			break;
		case 9:
			g_snprintf(value, sizeof(value), "%.9f", val);
			break;
		case 10:
			g_snprintf(value, sizeof(value), "%.10f", val);
			break;
		case 11:
			g_snprintf(value, sizeof(value), "%.11f", val);
			break;
		case 12:
			g_snprintf(value, sizeof(value), "%.12f", val);
			break;
		case 13:
			g_snprintf(value, sizeof(value), "%.13f", val);
			break;
		case 14:
			g_snprintf(value, sizeof(value), "%.14f", val);
			break;
		case 15:
			g_snprintf(value, sizeof(value), "%.15f", val);
			break;
		case 16:
			g_snprintf(value, sizeof(value), "%.16f", val);
			break;
...
/* GTK3: gtk_scale_clear_marks() always available */
