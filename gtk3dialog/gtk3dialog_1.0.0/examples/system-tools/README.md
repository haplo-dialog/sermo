...
appeler une fonction bash du script parent : gtk3dialog lance un sous-shell.
...
gtk3dialog qui dépasse la boîte de dialogue.
...
- `set -e` et `trap ERR` sont volontairement absents : gtk3dialog renvoie un
