...
URL: https://haplo-dialog.fr/pub/gtk3dialog/%{name}-%{version}.tar.gz
BuildRoot: /var/tmp/%{name}-%{version}

Summary: GTK3 GUI creation tool for shells and arbitrary interpreters. 

%description
gtk3dialog uses an XML like simple language as a GUI description
