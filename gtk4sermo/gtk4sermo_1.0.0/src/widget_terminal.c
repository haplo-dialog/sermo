...
a version of gtk4sermo built with libvte."
...
#else
	/* VTE < 0.26 not supported in this GTK4 port — build with vte-2.91 */
	g_warning("%s(): VTE < 0.26 not supported by gtk4sermo GTK4 port", __func__);
	pid = 0;
#endif
