...
# Résultat
ls /tmp/gtk4sermo-1.1.2-x86_64-1_sermo.tgz
```

## Installation

```bash
sudo installpkg /tmp/gtk4sermo-1.1.2-x86_64-1_sermo.tgz
# ou
sudo upgradepkg --install-new /tmp/gtk4sermo-1.1.2-x86_64-1_sermo.tgz
```
